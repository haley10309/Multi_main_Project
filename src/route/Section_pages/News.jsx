  ...
  return (
    <div className="home_body">
      ...
      <div className="section_navigation_bar">
        <Link className="section_single_manu" activeClassName="active" to={'../Forum_page/Whole'} state={{forum_name:forumName}}><li className="section_menu_li">전체</li></Link>
        <Link className="active_menu" activeClassName="active" to={'../Forum_page/News'} state={{forum_name:forumName}}><li className="section_menu_li">뉴스</li></Link>
          ...
          <div className="board_title">
            <div>
              <Link
                ...
                state={{ forum_name: "하영" }}
              >
                <li className="title_li">news {forumName}</li>
              </Link>
            </div>
